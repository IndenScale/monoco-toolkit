...
type: chore
status: closed
title: Complete Monoco i18n Command Documentation
created_at: "2026-01-09"
solution: "completed"
tags: ["documentation", "i18n", "cli"]
---

## CHORE-0001: 完善 monoco i18n 命令文档
...
- [x] **Enhance CLI Docstrings**: 优化 `Toolkit/monoco/features/i18n/commands.py` 中的 help 文本。
- [x] **Create User Manual**: 撰写 `Toolkit/docs/zh/i18n/manual.md`。
- [x] **Update Index**: 更新项目文档索引，纳入 i18n 手册。
