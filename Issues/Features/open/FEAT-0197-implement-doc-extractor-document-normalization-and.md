...
updated_at: '2026-02-09T21:03:51'
parent: EPIC-0000
dependencies: []
related: []
domains: []
...
- [ ] 支持 PDF 渲染为 WebP 页面序列
- [ ] 支持 docx/pptx/xlsx 转换为 PDF 后渲染
- [ ] 支持图片 (png/jpg) 转为单页 PDF 后渲染
- [ ] 支持压缩文件 (zip/tar.gz) 扁平化解压后处理
- [ ] 基于原始文件哈希的缓存机制
- [ ] 正确的目录结构和元数据生成
- [ ] CLI 接口完整实现
- [ ] 纯 CPU 运行，无模型依赖
