...
- [x] **Refactor `monoco/daemon/services.py`**:
  - [x] 复查 `ProjectManager.scan` 逻辑，确保对 CWD 的处理符合预期。
- [x] **Refactor `monoco/features/issue/commands.py`**:
  - [x] 修改 `_resolve_issues_root` 函数，实现路径探测（Smart Path Resolution）。
