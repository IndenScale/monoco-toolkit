...
updated_at: 2026-01-30 08:38:48
parent: EPIC-0001
dependencies: []
related:
- FEAT-0114
...
isolation:
  type: branch
  ref: feat/fix-0020-domain-linter-fails-to-validate-domain-name-strict
  path: null
  created_at: '2026-01-30T08:38:48'
---
...
## Acceptance Criteria
- [ ] Linter 校验 domain 格式必须为 PascalCase
- [ ] Linter 错误信息明确提示格式要求和可用列表
- [ ] 提供 `--fix` 自动修复：
  - 去除引号
  - 空格转为 PascalCase（`Issue Tracing` → `IssueTracing`）
- [ ] 更新文档说明 Domain 命名规范
